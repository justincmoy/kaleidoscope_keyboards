...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [DVORAK] = LAYOUT_split_3x5_3(
    ...
    KC_SLSH, KC_Q,    KC_J,           KC_K,           KC_X,            KC_B,            KC_M,             KC_W,           KC_V,    KC_Z,
                      LGUI_T(KC_ESC), LCTL_T(KC_TAB), LT(NUM, KC_SPC), LSFT_T(KC_ENT),  LT(SYM, KC_BSPC), LT(NAV, KC_DEL)
  ),
  ...
  [GAME] = LAYOUT_split_3x5_3(
    ...
    KC_LCTL, KC_Z,    KC_X,           KC_C,            KC_V,           KC_B,            KC_M,             KC_W,           KC_V,    KC_Z,
                      KC_ESC,         LT(NUM, KC_TAB), KC_SPC,         LSFT_T(KC_ENT),  LT(SYM, KC_BSPC), LT(NAV, KC_DEL)
  ),
  ...
  [NUM] = LAYOUT_split_3x5_3(
    ...
    KC_LGUI, KC_LALT, KC_LCTL,        KC_LSFT,        KC_NO,           KC_NO,           KC_LSFT,          KC_LCTL,        KC_LALT, KC_LGUI,
                      LGUI_T(KC_ESC), LCTL_T(KC_TAB), LT(NUM, KC_SPC), LT(SYM, KC_ENT), LT(SYM, KC_BSPC), LT(NAV, KC_DEL)
  ),
