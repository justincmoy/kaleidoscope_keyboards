...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [GAME] = LAYOUT(
    KC_GRV,  KC_1, KC_2, KC_3, KC_4,                                     KC_F,            KC_G,            KC_C,  KC_R,  TG(GAME),
    KC_ESC,  KC_Q, KC_W, KC_E, KC_R,                                     KC_D,            KC_H,            KC_T,  KC_N,  KC_S,
    KC_LSFT, KC_A, KC_S, KC_D, KC_F,   KC_G,            KC_NO,           KC_B,            KC_M,            KC_W,  KC_V,  KC_Z,
