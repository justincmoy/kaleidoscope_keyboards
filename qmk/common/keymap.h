...
#define KC_HR_1_1_3 TD(TD_HR_1_1_3)
#define KC_HR_1_1_6 TD(TD_HR_1_1_6)
...
#define KC_HR_2_1_0 TD(TD_HR_2_1_0)
#define KC_HR_2_1_1 KC_2
#define KC_HR_2_1_2 TD(TD_HR_2_1_2)
#define KC_HR_2_1_3 TD(TD_HR_2_1_3)
#define KC_HR_2_1_6 TD(TD_HR_2_1_6)
#define KC_HR_2_1_7 TD(TD_HR_2_1_7)
#define KC_HR_2_1_8 KC_9
#define KC_HR_2_1_9 TD(TD_HR_2_1_9)

#define KC_HR_2_3_2 KC_USED
#define KC_HR_2_3_3 TG(LAYER_HR_4)

#define KC_HR_3_1_0 OSM(MOD_LGUI)
#define KC_HR_3_1_1 OSM(MOD_LALT)
#define KC_HR_3_1_2 KC_USED
#define KC_HR_3_1_3 OSM(MOD_LSFT)
#define KC_HR_3_1_6 KC_LEFT
#define KC_HR_3_1_7 KC_DOWN
#define KC_HR_3_1_8 KC_UP
#define KC_HR_3_1_9 KC_RIGHT

#define KC_HR_3_3_2 KC_NO
#define KC_HR_3_3_3 OSM(MOD_LCTL)
