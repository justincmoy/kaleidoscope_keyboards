...
#define KC_NUMB_0_8 KC_GRV
#define KC_NUMB_0_9 KC_RBRC

#define KC_NUMB_1_0 KC_1
#define KC_NUMB_1_1 KC_2
#define KC_NUMB_1_2 KC_3
#define KC_NUMB_1_3 KC_4
#define KC_NUMB_1_4 KC_5
#define KC_NUMB_1_5 KC_6
#define KC_NUMB_1_6 KC_7
#define KC_NUMB_1_7 KC_8
#define KC_NUMB_1_8 KC_9
#define KC_NUMB_1_9 KC_0

#define KC_NUMB_2_0 KC_LGUI
